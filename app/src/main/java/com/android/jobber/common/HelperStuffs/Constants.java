...
public class Constants {
    ...
    public static class BottomNavConstants {
        public static final int MENU_MY_PUBLISHING_SCREEN = R.id.action_publishing;
        public static final int MENU_TIME_LINE_SCREEN = R.id.action_timeline;

        public static final int JOBBER_ACCOUNT =R.id.action_brokers ;
        public static final int ACTION_FAVORITES =R.id.favorite_nav ;
        public static final int ACTION_REVIEWS = R.id.action_rate_Reviews;
        public static final int ACTION_PROFILE = R.id.action_profile;
        public static final int ACTION_REQUESTS_PRODUCTS = R.id.action_requests_nav;
        public static final int ACTION_BROKERS = R.id.action_brokers;
        public static final int ACTION_CHAT_ROOMS = R.id.action_chat_nav;
    }
